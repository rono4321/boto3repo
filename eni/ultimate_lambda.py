...
def lambda_handler(event, context):
    ...
    response6 = ec2.create_network_interface(
    ...
    eni2=response6['NetworkInterface']['NetworkInterfaceId']
    
    ##Attach ENI to instance
    response7 = ec2.attach_network_interface(
        DeviceIndex=2,
        InstanceId=EC2InstanceId,
        NetworkInterfaceId=eni2
    )
    
    eni_attach_id2=response7['AttachmentId']
    response8 = ec2.modify_network_interface_attribute(Attachment={'AttachmentId': eni_attach_id2,'DeleteOnTermination': True},NetworkInterfaceId=eni2,)
